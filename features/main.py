...
from machine import machine_helpers
...
def feature_extract_cell_line(cell_line, pulse_path, preprocess_input_path, feature_extract_output_path):
    ...
    if pfam_exit_code == 0:
        ...
        if remap_exit_code == 0:
            ...
            as_location_file = preprocess_input_path + '/as_location.out'
            remapped_coordinates_file = feature_extract_output_path + '/report_conservationQuery.txt.xls'
            ...
            machine_helpers.create_paths_for_cell_line(pulse_path, cell_line)
